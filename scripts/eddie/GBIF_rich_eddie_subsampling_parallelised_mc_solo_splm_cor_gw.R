...
subsampling.plants <- function(spec_n) {
  ...
  if (nrow(species_sample) %in% seq(1,nrow(plantlist_names),50000)){
    tf1 <- paste0("/exports/eddie/scratch/s2117440/data/richness/checkpoints/checkpoint_rich_gbif_",
...
res_file <- paste0("/exports/eddie/scratch/s2117440/data/richness/Samples_iteration_splm_rich_gbif",
