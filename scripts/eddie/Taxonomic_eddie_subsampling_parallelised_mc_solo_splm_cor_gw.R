...
subsampling.plants <- function(spec_n) {
  ...
  if (nrow(species_sample) %in% seq(1,nrow(plantlist_names),50000)){
    tf1 <- paste0("/exports/eddie/scratch/s2117440/data/taxonomic/checkpoints/checkpoint_tax",
...
res_file <- paste0("/exports/eddie/scratch/s2117440/data/taxonomic/Samples_iteration_splm_tax",
