...
objective <- function(subset_indices) {
  ...
  sample_rich_bru <- dist %>%
   ...
   #cor.spatial(rich_rel_shp$richness, rich_rel_shp$richness_sample, rich_rel_shp@coords)
   #orf <- codisp(rich_rel_shp$richness, rich_rel_shp$richness_sample, rich_rel_shp@coords, nclass = 368)
