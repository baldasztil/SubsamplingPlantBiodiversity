...
subsampling.plants <- function(spec_n) {
  ...
  if (nrow(species_sample) %in% seq(1,nrow(plantlist_names),50000)){
    tf1 <- paste0("data/richness/checkpoints/checkpoint_rich_",nrow(species_sample),".parquet")
...
file <- paste0("data/richness/Samples_iteration_splm_rich",
