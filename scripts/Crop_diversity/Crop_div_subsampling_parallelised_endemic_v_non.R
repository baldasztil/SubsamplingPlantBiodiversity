...
# this creates a foor loop around the function 
...
data_out_end <- as.data.frame(do.call(bind_rows, samples_rel))
write.txt(data_out_end, "samples_end_rel.txt")
...
data_out_wide <- as.data.frame(do.call(bind_rows, samples_rel))
write.txt(data_out_wide, "samples_wide_rel.txt")
