...
Sys.time()
endwithin <- rbindlist(results)
write.table(endwithin, paste0("data/endemic_within/Samples_iteration_gwr_future_end_within",sample(1:10000000, 1, replace=TRUE),".txt")) 
