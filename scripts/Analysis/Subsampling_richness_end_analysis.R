...
list_data <- list.files("C:/Users/s2117440/OneDrive - Royal Botanic Garden Edinburgh/A_PhD/Chapters/Chapter1_UNEP_KEW/Projects/SubsamplingPlantBiodiversity/data/end_nonend/end", full.names = TRUE)
#Read them in a list
...
ggsave(file = paste0("curves_endemic_cropdiv", 
...
ggsave(file = paste0("maps_curves_endemic", 
                     "_cropdiv.jpeg"),g,   
       width = 22, height = 10, dpi = 600)
