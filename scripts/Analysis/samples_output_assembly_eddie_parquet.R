...
samples_cumulative_rel <- rollup(sample_data, list("mean_corgw" = mean(cor.sp_gwr_mean), 
...
rm(sample_data)
gc()
write_parquet(samples_cumulative_rel, paste0("data/samples_aggregated/parquetfullsamples_", index_source[1], "_", index_source[2], ".parquet"))
#Output analysis----------------------------------------------------------------
